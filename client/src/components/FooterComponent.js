                ...
                <div className="row justify-content-center">             
                    ...
                    <div className="col-12 col-sm-4 align-self-center">
                        <div className="text-center">
                            ...
                            <a className="btn btn-social-icon btn-github" href="https://github.com/sheshan23/Restaurant-Management-Web-App" target="_blank" rel="noopener noreferrer"><i className="fa fa-github"></i></a>
